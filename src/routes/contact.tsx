			...
			<section className="relative py-32 md:py-40 px-4 sm:px-6 md:px-8 text-center overflow-hidden">
				...
				>
					...
					<motion.p
						...
						variants={heroItemVariants}
					>
						Have a question, a project idea, or want to collaborate? We'd love
						to hear from you. Reach out and let's start a conversation.
					</motion.p>
				</motion.div>
			</section>
			...
			>
				<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
					...
					<div className="space-y-12">
						<div>
							<h2 className="text-3xl sm:text-4xl font-medium text-white font-heading">
								Contact Information
							</h2>
						...
						<div className="space-y-8">
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<a
										href="mailto:catalyst@aissmsioit.org"
										className="text-white/70 hover:text-white transition-colors"
									>
										catalyst@aissmsioit.org
									</a>
								</div>
							</div>
							<div className="flex items-start gap-4">
						...
						<div className="pt-8 border-t border-white/10">
							...
							<div className="mt-4 flex space-x-6">
								<a
									href="https://www.linkedin.com/company/catalystioit/"
									className="text-white/60 hover:text-white transition-colors"
								>
									<LinkedInIcon className="h-6 w-6" />
								</a>
								<a
									href="https://www.instagram.com/catalyst.ioit/"
									className="text-white/60 hover:text-white transition-colors"
								>
						...
						<form onSubmit={handleSubmit} className="space-y-6">
							...
							<div className="flex items-center gap-4">
								...
								{formStatus.info.msg && (
									<p
										className={`text-sm ${
											formStatus.info.error ? "text-red-500" : "text-green-500"
										}`}
									>
										{formStatus.info.msg}
									</p>
