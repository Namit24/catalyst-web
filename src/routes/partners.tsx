			...
			<AnimatedSection className="py-32 px-4 sm:px-6 md:px-8 text-center bg-[#1a1a1a]/50">
				<div className="max-w-3xl mx-auto">
					...
					<p className="mt-6 text-lg text-white/70">
						We are always seeking new opportunities to collaborate on projects,
						host events, or create educational content. If your organization
						shares our vision, we'd love to hear from you.
					</p>
					<div className="mt-12">
						<a
